...
// import "../../CSS/AnimeRecomendations.css";
...
const AnimeRecomendations = () => {
  ...
  const mainUrl = `https://api.jikan.moe/v4/recommendations/anime?page=${Page}`;
  ...
  return isLoading && FetchedData ? (
    ...
    <div className="All-anime-page w-full">
      <h1 className="text-3xl text-yellow-500 p-5">Anime Recomendations</h1>
      ...
      <div className="all-anime-block grid grid-cols-4 w-full">
        {!FetchedData ? (
          ...
          FetchedData.map((item, index) => {
            ...
            return (
              <Link key={index} to={`/Anime/${mal_id}`}>
